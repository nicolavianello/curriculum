...
% \cvitem{2007--2015}{ Responsible Officer (RO) for edge manipulators in RFX-mod
% device}
% \cvitem{2015-2016}{ RO Soft X ray diagnostic in the
%   TCV tokamak. Deputy RO for the Neutral Beam
%   Heating system in the TCV tokamak.}
% \cvitem{2009}{RFX-mod: Task force leader for task force
% \emph{Particle, Momentum and energy transport}}
% \cvitem{2010}{RFX-mod: Task force leader for task force
...
\cvitem{2019-20}{Scientific Coordinator of Topic 16
  \emph{Effect of filamentary transport on heat and particle loads}  under MST1 Eurofusion Work-Package.}
...
\cvitem{2019-20}{Scientific Coordinator of M18-41 Experiment
  \emph{Divertor geometry effect on detachment and SOL} under JET1
  Eurofusion Work-Package}
\end{cvblock}
