...
\addbibresource{~/Dropbox/Work/Curriculum/utils/biblio10.bib}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\nocite{*}
\printbibliography[type=article, title={Prodotti della ricerca scelti}, heading=subbibliography, prefixnumbers={A}, resetnumbers=true]
