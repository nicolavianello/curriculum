\begin{cvblock}{Ruoli e responsabilit{\`a}}
    \cvitem{2007--2015}{Responsabile per i manipolatori remoti e le
...
\cvitem{2009}{Task force leader per l'esperimento RFX-mod experiment della task force
...
\cvitem{2010}{Task force leader per l'esperimento RFX-mod experiment della task force
\emph{Physics integration for high performance RFP}. La task aveva
  l'incarico di implementare il programma scientifico e coordinare
  l'attivit{\`a} di analisi atte alla comprensione dei meccanismi
  fisici alla base della transizione ai regimi di confimanento
  migliorati osservati ad alta corrente.}

%\\[-4pt]

\cvitem{2011}{Coordinatore del working group EFDA  \emph{3D field effects in
...
\item Caratterizzazione della turbolenza nella region esterna in
  sistemi 3D, inclusi gli effetti su ioni ed elettroni sovra-termici
...
\end{enumerate}
I coordinatori promuovo piattaforme di discussione fra ele diverse
...
\cvitem{2018}{Coordinatore scientifico del task T18-02 
...
% \cvitem{2010}{Partecipazione alla task EFDA WP10-TRA-05 \emph{Statistical properties of edge turbulent transport}, sotto task WP10-TRA-05-01-xx-01/ENEA_RFX/BS, WP10-TRA-05-01-xx-02/ENEA_RFX/BS, WP10-TRA-05-01-xx-03/ENEA_RFX/BS}

% \cvitem{2011}{Partecipazione alla task EFDA WP11-TRA-05
%   \emph{Statistical properties of edge turbulent transport: role of
%     3-D physics}, sotto task WP11-TRA-05-01-01/ENEA_RFX,
%   WP11-TRA-05-01-02/ENEA_RFX/, WP11-TRA-05-01-03/ENEA_RFX}

% \cvitem{2012}{Partecipazione alla task EFDA WP12-IPH-A06
%   \emph{Pedestal Instabilities (ELMs) Mitigation and Heat Loads} sotto
%   task WP12-IPH-A06-1-1-05/PS-01/ENEA_RFX e WP12-IPH-A06-2-01}
