...
the two manipulator used in RFX-mod for the insertion of edge probes,
including the probe heads. Development has required the design of new
...
charge to implement experimental proposal aimed to the comprehension
...
could help to improve plasma performances. As in the previous year, as
Task Force I take part to the scientific programme schedule,
...
Topical Group umbrella. This working group has been established to
